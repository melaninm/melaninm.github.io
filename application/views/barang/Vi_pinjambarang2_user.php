    ...
    <div class="card">
      ...
      <div class="card-body card-block">
        ...
        <div class="bootstrap-iso">
          <form action="<?php echo site_url('crudpinjambarang/todetail_user'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
            <?php foreach ($tbl_pinjambarang as $detail) { ?>
              ...
              <div class="row form-group">
                ...
                <!-- <div class="col-12 col-md-9"><input type="hidden" id="id_user" name="id_user" value="<?= $tbl_login['id']; ?>" class="form-control" ></div>     -->
              </div>
              <div class="row form-group">
                            ...
                            <tbody>
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td>
                                    <a class="btn btn-danger btn-sm" href="<?php echo site_url('crudpinjambarang/hapus_user/' . $br->id_barang . '/' . $br->id_pb); ?>" class="btn btn-small"><i class="fa fa-trash-o"></i>Hapus</a>
                                  </td>
                                </tr>
                              <?php } ?>
                            </tbody>
          ...
          <div class="card-footer">
            ...
            <!--class="btn btn-small"
              ...
              <a type="button" class="btn btn-primary btn-sm" href="<?= base_url('crudpinjambarang/kepinjambarang_user/'); ?>"><i class="fa fa-dot-circle-o"></i> Selesai</a>

            <a class="btn btn-danger btn-sm" class="btn btn-small" href="<?= base_url('crudpinjambarang/cancel_user/' . $detail->id_pb); ?>">
              <i class="fa fa-ban"></i> Batal
            </a>
            -->
          </div>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a type="button" class="btn btn-primary" href="<?php echo site_url('crudpinjambarang/kepinjambarang_user'); ?>">Ya, Selesai</a>
      </div>
    </div>
  </div>
</div>
