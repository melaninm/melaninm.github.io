...
<SPAN LANG="id-ID"><U><B>BERITA ACARA PENGGUNAAN BARANG </B></U></SPAN><br/>
<SPAN LANG="sv-SE">NOMOR : </SPAN><SPAN LANG="id-ID"><?php echo $detail->id_pb; ?></SPAN></P>
...
<SPAN LANG="id-ID">Tanggal </SPAN><?php echo date_indo($detail->tanggal); ?> Tujuan <SPAN LANG="id-ID"><?php echo $detail->tujuan ?>.</SPAN>
	...
	<TABLE WIDTH=631 CELLPADDING=2 CELLSPACING=0>
		<TR VALIGN=TOP>
			...
			<TD COLSPAN=3 WIDTH=284 STYLE="border: none; padding: 0in">
				<P LANG="en-US" CLASS="western" ALIGN=JUSTIFY>
				<SPAN LANG="id-ID">Selaku Pengendali Ruangan dan Barang Fakultas Ilmu Sosial dan Politik	UIN Sunan Gunung Jati Bandung,	Selanjutnya disebut <B>PIHAK
				PERTAMA</B></SPAN></P>
			</TD>
		</TR>
		<TR VALIGN=TOP>
			...
			<TD COLSPAN=3 WIDTH=284 STYLE="border: none; padding: 0in">
				<P LANG="en-US" CLASS="western" ALIGN=JUSTIFY>
				<SPAN LANG="id-ID">AN. Mahasiswa Fakultas Ilmu Sosial dan Politik UIN Sunan Gunung Jati Bandung  Selaku Kuasa Izin Peminjam Barang Selanjutnya disebut <B>PIHAK
				KEDUA</B></SPAN></P>
			</TD>
		</TR>
	</TABLE>
...
<TABLE WIDTH=631 CELLPADDING=7 CELLSPACING=0>
	...
	<TR>
		...
		<TD STYLE="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
			<P LANG="en-US" CLASS="western" ALIGN=LEFT VALIGN=CENTER><FONT SIZE=2 STYLE="font-size: 9pt"><SPAN LANG="id-ID"><?php echo $br->unitb ?></SPAN></FONT></P>
		</TD>
		<TD STYLE="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
...
barang ini, <B>PIHAK KEDUA</B> dapat mempergunakan
terhitung sejak tanggal <?php echo date_indo($detail->tanggal); ?> <B>PIHAK
KEDUA</B> bertanggung jawab untuk barang tersebut serta sanggup untuk mengembalikan kepada <B>PIHAK PERTAMA</B> dalam
keadaan Fakultas, <B>PIHAK
