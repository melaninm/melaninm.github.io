                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger btn-sm" href="<?php echo site_url('laporanbarang/hapus_user/' . $br->id_pb); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data? ');" class="btn btn-small" data-popup="tooltip" data-placement="top" title="Hapus Data"><i class="fa fa-trash-o"></i>Hapus</a>
