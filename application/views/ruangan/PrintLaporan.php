...
<SPAN LANG="id-ID"><U><B>BERITA ACARA PENGGUNAAN RUANGAN </B></U></SPAN><br/>
<SPAN LANG="sv-SE">NOMOR : </SPAN><SPAN LANG="id-ID"><?php echo $detail->id_pr; ?></SPAN></P>
	...
	<TABLE WIDTH=631 CELLPADDING=2 CELLSPACING=0>
		<TR VALIGN=TOP>
			...
			<TD COLSPAN=3 WIDTH=284 STYLE="border: none; padding: 0in">
				<P LANG="en-US" CLASS="western" ALIGN=JUSTIFY>
				<SPAN LANG="id-ID">AN. Mahasiswa Fakultas Ilmu Sosial dan Politik UIN Sunan Gunung Jati Bandung  Selaku Kuasa Izin Peminjam Ruangan Selanjutnya disebut <B>PIHAK
				PERTAMA</B></SPAN></P>
			</TD>
		</TR>
		<TR VALIGN=TOP>
			...
			<TD COLSPAN=3 WIDTH=284 STYLE="border: none; padding: 0in">
				<P LANG="en-US" CLASS="western" ALIGN=JUSTIFY>
				<SPAN LANG="id-ID">Selaku Pengendali Ruangan dan Barang Fakultas Ilmu Sosial dan Politik	UIN Sunan Gunung Jati Bandung, Natar	Selanjutnya disebut <B>PIHAK
				KEDUA</B></SPAN></P>
			</TD>
		</TR>
	</TABLE>
...
ruangan tersebut di bawah ini dalam keadaan baik, dengan perincian sebagai berikut :</SPAN></P>
<P ALIGN=CENTER STYLE="margin-bottom: 0in">
</P>
<TABLE ALIGN=CENTER WIDTH=363 CELLPADDING=7 CELLSPACING=0>
	<COL WIDTH=17>
	<COL WIDTH=76>
	<COL WIDTH=100>
	<COL WIDTH=57>
	...
	<TR>
		...
		<TD STYLE="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
			<P LANG="en-US" CLASS="western" ALIGN=LEFT VALIGN=CENTER><FONT SIZE=2 STYLE="font-size: 9pt"><?php echo $br->kode_ruangan ?></FONT></P>
		</TD>
		<TD STYLE="border: 1px solid #00000a; padding-top: 0in; padding-bottom: 0in; padding-left: 0.08in; padding-right: 0.08in">
			<P LANG="en-US" CLASS="western" ALIGN=LEFT VALIGN=CENTER STYLE="margin-right: -0.08in">
			<FONT SIZE=2 STYLE="font-size: 9pt"><SPAN LANG="id-ID"><?php echo $br->nama_ruangan ?></SPAN></FONT></P>
		</TD>
...
ruangan ini, <B>PIHAK KEDUA</B> dapat mempergunakannya terhitung sejak tanggal <?php echo date_indo($detail->tanggal); ?> <B>PIHAK
KEDUA</B> bertanggung jawab untuk ruangan tersebut dalam
keadaan baik dan tanpa syarat apapun juga.</br>Apabila terjadi kehilangan atau kerusakan fasilitas di ruangan
Milik Fakultas tersebut, sehingga menimbulkan kerugian Fakultas, <B>PIHAK
KEDUA</B> bertanggung jawab mutlak, dan
tunduk pada peraturan yang berlaku.</br>Demikian Berita Acara Penggunaaan Ruangan ini dibuat menurut keadaan yang sebenarnya.</SPAN></P>
<br>
<CENTER>
	<TABLE WIDTH=641 CELLPADDING=7 CELLSPACING=0>
		...
		<TR VALIGN=TOP>
			...
			<TD COLSPAN=3 WIDTH=284 HEIGHT=91 STYLE="border: none; padding: 0in">
				...
				<P LANG="en-US" CLASS="western" ALIGN=CENTER >
				<FONT SIZE=2 STYLE="font-size: 11pt"><SPAN LANG="es-ES"><B>NIM.
				</B></SPAN></FONT><FONT SIZE=2 STYLE="font-size: 11pt"><SPAN LANG="id-ID"><B></B></SPAN></FONT></P>
				<P ALIGN=CENTER><BR>
				</P>
			</TD>
