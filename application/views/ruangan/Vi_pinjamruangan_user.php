    ...
    <div class="card">
        ...
        <div class="card-body card-block">
            <div class="bootstrap-iso">
                <form action="<?php echo site_url('crudpinjamruangan/tomaster_user'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                   <div class="row form-group">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="nama1" name="nama1" disabled="" placeholder="Admin Lab FISIP" class="form-control" required reado></div>
                    </div>
                    <div class="row form-group">
