    ...
    <div class="card">
        ...
        <div class="card-body card-block">
            ...
            <div class="bootstrap-iso">
                <form action="<?php echo site_url('crudpinjamruangan/todetail'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <?php
                    ...
                    ?>
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="hidden" id="idpr" name="idpr" value="<?php echo $detail->id_pr; ?>" class="form-control"></div>
                        </div>
                        <div class="row form-group">
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a type="button" class="btn btn-primary" href="<?php echo site_url('crudpinjamruangan/kepinjamruangan'); ?>">Ya, Selesai</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="staticModal<?php echo $detail->id_pr; ?>" tabindex="-1" role="dialog" aria-labelledby="staticModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tidak</button>
                <a type="button" class="btn btn-primary" href="<?php echo site_url('crudpinjamruangan/hapusall/' . $detail->id_pr); ?>">Ya, Batal</a>
            </div>
        </div>
    </div>
</div>